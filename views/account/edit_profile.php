        ...
        <form method="post" action="<?= URL ?>compte/validation_modification_profil" enctype="multipart/form-data">
            <div class="form-wrap form-wrap-secondary">
                ...
                <div class="input-section-secondary">
                    ...
                    <input type="text" name="firstName" id="firstName" placeholder="Veuillez saisir votre prénom" required value="<?php if(!empty($user_data->getFirstName())) {echo ($user_data->getFirstName());}?>">
                    ...
                    <input type="text" name="lastName" id="lastName" placeholder="Veuillez saisir votre nom" required value="<?php if(!empty($user_data->getLastName())) {echo ($user_data->getLastName());}?>">
                    ...
                    <input type="text" name="phone" id="phone" placeholder="Votre numéro de téléphone" required value="<?php if(!empty($user_data->getPhone())) {echo ($user_data->getPhone());}?>">
                </div>
                ...
                <div class="input-section-secondary">
                    ...
                    <input type="text" name="address" id="address" placeholder="Veuillez saisir votre adresse" required value="<?php if(!empty($user_data->getAddress())) {echo ($user_data->getAddress());}?>">
                    ...
                    <input type="text" name="postal" id="postal" placeholder="Veuillez saisir votre code postal" required value="<?php if(!empty($user_data->getPostal())) {echo ($user_data->getPostal());}?>">
                    ...
                    <input type="text" name="city" id="city" placeholder="Veuillez saisir votre ville" required value="<?php if(!empty($user_data->getCity())) {echo ($user_data->getCity());}?>">
                    ...
                    <input type="text" name="country" id="country" placeholder="Veuillez saisir votre pays" required value="<?php if(!empty($user_data->getCountry())) {echo ($user_data->getCountry());}?>">      
